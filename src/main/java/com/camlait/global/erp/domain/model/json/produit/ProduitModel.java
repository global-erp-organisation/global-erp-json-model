...
public class ProduitModel extends Entite {
    ...
    public Collection<ProduitTaxeModel> getProduitTaxes() {
        return produitTaxeModels;
    }
    
    public void setProduitTaxes(Collection<ProduitTaxeModel> produitTaxeModels) {
    ...
    public ProduitModel(Produit p) {
        this.categorieId = p.getCategorie().getCategorieProduitId();
        this.codeProduit = p.getCodeProduit();
        this.dateDeCreation = p.getDateDeCreation();
        this.derniereMiseAJour = p.getDerniereMiseAJour();
        this.descriptionProduit = p.getDescriptionProduit();
        this.prixUnitaireMarge = p.getPrixUnitaireMarge();
        this.prixUnitaireProduit = p.getPrixUnitaireProduit();
        this.produitId = p.getProduitId();
        this.produitTaxeModels = getTaxes(p);
        this.produitTaxable = p.isProduitTaxable();
        this.suiviEnStock = p.isSuiviEnStock();
    }
